        ...
        mainPanel(
            tabsetPanel(
                tabPanel(
                         ...
                         numericInput("elem", "Digite a quantidade de elementos " ,value = 20, step = 1 ),
                         numericInput("tam", "Digite o tamanho da amostra " ,value = 200, step = 1 ),
                ...
                tabPanel(
                        ...
                        numericInput("elem2", "Digite a quantidade de elementos " ,value = 20, step = 1 ),
                        numericInput("tam2", "Digite o tamanho da amostra " ,value = 200, step = 1 ),
                        numericInput("tamp", "Digite o tamanho da pop" ,value = 200, step = 1 ),
                ...
                tabPanel(icon = icon("tag"),"Dif entre 2 pop", 
                         numericInput("elem3", "Digite a quantidade de elementos 1 " ,value = 20, step = 1 ),
                         numericInput("tam3", "Digite o tamanho da amostra 1 " ,value = 200, step = 1 ),
                         numericInput("elem4", "Digite a quantidade de elementos 2 " ,value = 20, step = 1 ),
                         numericInput("tam4", "Digite o tamanho da amostra 2" ,value = 200, step = 1 ),
        ...
        tabPanel(
             ...
             mainPanel(
                 ...
                 tabsetPanel(
                     tabPanel(
                         icon = icon("tag"), "Pop Infinita",
                         numericInput("err", "Digite o erro" , value = 0.03 ),
                         numericInput("phat", "Digite a prop sucesso " , value = 0.25, min = 0, max = 1, step = 0.01 ),
                     ...
                     tabPanel(
                         icon = icon("tag"),"Pop Finita",
                         numericInput("phat2", "Digite a prop sucesso " , value = 0.25, min = 0, max = 1, step = 0.01 ),
                         numericInput("err2", "Digite o erro " ,value = 0.03, step = 1 ),
                         numericInput("tamp2", "Digite o tamanho da pop" ,value = 200, step = 1 ),
